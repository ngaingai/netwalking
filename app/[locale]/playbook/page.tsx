...
function markdownToHtml(md: string): string {
  ...
  html = html
    .replace(/NetWalking/g, '<span class="text-brand-teal">Net</span>Walking')
    .replace(/NiteWalking/g, '<span class="text-brand-teal">Nite</span>Walking')
    .replace(/NetRunning/g, '<span class="text-brand-teal">Net</span>Running')
    .replace(/NetChilling/g, '<span class="text-brand-teal">Net</span>Chilling')
    .replace(/Alex Ngai/g, '<a href="https://www.linkedin.com/in/alex-ngai/" target="_blank" rel="noopener noreferrer" class="text-brand-teal hover:underline">Alex Ngai</a>');
