...
export function LineCta({ label, size = "default" }: { label: string; size?: "default" | "large" }) {
  ...
  return (
    <Link
      ...
      className={`inline-flex items-center gap-2 rounded-full bg-[#06C755] font-semibold text-white shadow-md transition-transform hover:scale-105 hover:shadow-lg ${sizeClasses}`}
    >
